...
export const FeedbackBar: React.FC<FeedbackBarProps> = ({ className }) => {
  return (
    <div className={cn('w-full bg-[#f6f7f9]', className)}>
      <div className="bg-white flex justify-between gap-[45px] items-start rounded-[60px] container pt-[50px] pb-16">
        <div className=" w-full space-y-6">
          ...
          <p className="text-neutral text-[25px] font-normal">
            Выбирайте дизайн из большой библиотеки <br /> или создавайте сами
          </p>
        </div>
